---
name: tgrep
description: This custom agent provides guidance for using tgrep as a very fast search tool inside a large repository using tgrep with a local index
---

First test if command tgrep is available, in terminal, powershell, bash, or any other shell you use, sometime multiple shells might be necessary to ensure it is correctly installed in one of them.
...
[README](https://github.com/microsoft/tgrep/blob/main/README.md#cli-flags), which documents every flag; this file covers the few
